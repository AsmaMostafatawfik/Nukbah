...
import { useEffect, useState } from "react";
import { useRouter, useParams } from "next/navigation";
import { FaArrowLeft, FaUsers, FaBookOpen, FaChalkboardTeacher } from "react-icons/fa";
...
export default function CourseDetailPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (!matchedCourse) throw new Error("Course not found");
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-50" dir="rtl">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600">جاري تحميل بيانات المقرر...</p>
        </div>
      </div>
    );
  }
  ...
  if (!course) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4" dir="rtl">
        <div className="max-w-md w-full bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
          <h2 className="text-xl font-medium text-gray-800 mb-4">لا توجد بيانات لهذا المقرر</h2>
          <button 
            onClick={() => router.push("/student/dashboard/courses")}
            className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors"
          >
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          <div className="flex flex-col lg:flex-row">
                ...
                {course.image ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-r from-gray-100 to-gray-200 flex items-center justify-center">
                    <div className="text-center p-4">
                      <FaBookOpen className="h-12 w-12 mx-auto text-gray-400 mb-2" />
                      <span className="text-gray-500">لا توجد صورة للمقرر</span>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="p-6 lg:w-1/2">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                ...
                <div className="bg-green-50 p-3 rounded-lg border border-green-100">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-700">المشتركين</span>
                  </div>
              ...
              {/* Course Description */}
              <div className="mt-6">
                <h2 className="text-xl font-semibold text-gray-800 mb-3">وصف المقرر</h2>
              ...
              <div className="mt-8">
                <button 
                  onClick={handleEnrollClick}
                  className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 text-white py-3 px-6 rounded-lg hover:from-indigo-700 hover:to-blue-700 transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                >
                  <span className="font-medium text-lg">اشترك الآن</span>
                </button>
              </div>
            </div>
          </div>
