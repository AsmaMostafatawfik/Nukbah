...
// import { PlusCircle, Video, FileText, ChevronDown, ChevronUp, Plus, Trash2, ChevronLeft ,EyeOff } from "lucide-react";
...
//   const navigateBack = () => {
//     router.push(
//       `/teacher/dashboard/${teacherId}/courses`
//     );
//   };
...
//         <h1 className="text-2xl md:text-3xl font-bold text-gray-800">جلسات الدورة</h1>
//         <button
...
//                 <div key={`mobile-session-${session.id}`} className="border p-4 rounded-lg">
//                   <div className="flex justify-between items-start">
//                     <div>
//                       <h3 className="font-medium">{session.title}</h3>
//                       <p className="text-sm text-gray-600 truncate">{session.content}</p>
//                       <p className="text-sm">الترتيب: {session.order}</p>
//                       <p className="text-sm">{new Date(session.published).toLocaleDateString()}</p>
//                     </div>
//                     <button 
...
//                               <div key={`mobile-video-${session.id}-${idx}`} className="border p-3 rounded-lg">
...
//                                 >
//                                   <source src={getFullVideoUrl(video.url)} type={`video/${video.url.split('.').pop()?.split('?')[0] || 'mp4'}`} />
...
//                           </div>
//                         ) : (
//                           <p className="text-gray-500 text-sm">لا توجد فيديوهات لهذه الجلسة</p>
//                         )}
//                       </div>
...
//                               <div key={`mobile-exam-${session.id}-${idx}`} className="border p-3 rounded-lg">
//                                 <div className="flex justify-between items-start">
//                                   <div>
...
//                           </div>
//                         ) : (
//                           <p className="text-gray-500 text-sm">لا توجد اختبارات لهذه الجلسة</p>
//                         )}
//                       </div>
//                     </div>
//                   )}
...
//                           </button>
//                         </td>
//                         <td className="py-4 px-4 max-w-xs truncate">{session.content}</td>
...
export default function CourseSessionsPage() {
  ...
  const navigateToSetVideoViews = (videoId: number) => {
    router.push(
      `/teacher/dashboard/${teacherId}/courses/${courseId}/videos/${videoId}/set-views`
    );
  };
                                ...
                                <div className="flex justify-between items-start mb-2">
                                  <div>
                                    ...
                                    {video.allowedViews !== undefined && (
                                      <p className="text-sm text-gray-600">
                                        المشاهدات المسموح بها: {video.allowedViews}
                                      </p>
                                    )}
                                  </div>
                                  <button
                                    onClick={() => navigateToSetVideoViews(video.id)}
