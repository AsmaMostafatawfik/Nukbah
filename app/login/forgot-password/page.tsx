...
//         <Image
//           src="/images/332005-PAO2M1-504.jpg" // Password reset illustration
...
//             {/* <h1 className="text-3xl font-bold mb-4">إعادة تعيين كلمة المرور</h1>
//             <p className="text-xl">أدخل بريدك الإلكتروني لاستعادة حسابك</p> */}
//           </div>
//         </div>
//       </div>
...
//                 className="mt-1 block w-full px-4 py-3 text-sm rounded-lg border border-gray-300 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none text-right"
//                 required
//               />
//             </div>
...
//             <button
//               type="submit"
//               className="w-full flex justify-center items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-all shadow-md"
//             >
//               إرسال رابط التعيين
