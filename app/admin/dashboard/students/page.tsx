...
//         const response = await fetch('http://elearning1.runasp.net/api/Admin/Students', {
//           headers: {
...
//       const response = await fetch(`http://elearning1.runasp.net/api/Admin/DeleteStudent/${id}`, {
//         method: 'DELETE',
//         headers: {
//           Authorization: `Bearer ${token}`,
//         },
...
//                                 <p>الجنس: {getGenderText(student.gender)}</p>
//                                 <p>العمر: {student.age}</p>
//                                 <p>هاتف ولي الأمر: {student.parentPhoneNumber}</p>
//                               </div>
//                             </div>
//                             <div className="space-y-2">
//                               <h4 className="font-medium text-gray-900">المعلومات التعليمية</h4>
//                               <div className="text-sm text-gray-500">
//                                 <p>المرحلة: {getStageText(student.educationalStage)}</p>
//                                 <p>الصف: {getGradeText(student.gradeLevel)}</p>
//                                 <p>المدرسة: {student.schoolName}</p>
//                               </div>
//                             </div>
//                             <div className="space-y-2">
//                               <h4 className="font-medium text-gray-900">صورة الطالب</h4>
//                               {student.image ? (
//                                 <img 
//                                   src={`data:image/jpeg;base64,${student.image}`} 
//                                   alt={student.fullName}
